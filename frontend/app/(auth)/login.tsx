...
const st = StyleSheet.create({
  ...
  forgotText: { fontSize: Typography.label, color: Colors.accentPeriwinkle, fontWeight: '600' },
  errorText: { fontSize: Typography.label, color: Colors.error, textAlign: 'center' },
  btnPrimary: { marginTop: Spacing.sm, backgroundColor: Colors.buttonPrimary, borderRadius: Radius.full, paddingVertical: 16, alignItems: 'center' },
